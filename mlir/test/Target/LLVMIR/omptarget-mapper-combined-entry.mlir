...
// CHECK: %[[MAPPER0:.*]] = getelementptr inbounds [5 x ptr], ptr %[[MAPPERS]], {{i(32|64)}} 0, {{i(32|64)}} 0
// CHECK: store ptr @.omp_mapper.mapper, ptr %[[MAPPER0]]
// CHECK: %[[MAPPER1:.*]] = getelementptr inbounds [5 x ptr], ptr %[[MAPPERS]], {{i(32|64)}} 0, {{i(32|64)}} 1
// CHECK: store ptr null, ptr %[[MAPPER1]]
// CHECK: %[[MAPPER2:.*]] = getelementptr inbounds [5 x ptr], ptr %[[MAPPERS]], {{i(32|64)}} 0, {{i(32|64)}} 2
